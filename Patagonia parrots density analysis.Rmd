...
## here is how Peter would do it
if (FALSE) {

VIP.boot.coefs<-rbind(coef(VIP.boot.coefs), t(sapply(VIPs, coef)))
coefCIs<-cbind(VIP.boot.coefs[1,], apply(VIP.boot.coefs, 2, quantile, c(0.025,0.975)))
colnames(coefCIs)<-c("Estimate","2.5%","97.5%")
