...
larger in urban (\(\beta\) = 1.739) and agropastoral (\(\beta\) = 1.739)
...
\midrule
\endhead
par1 & 1.007 & 0.019 & 53.262 & 0.000\tabularnewline
par2 & 1.739 & 0.023 & 75.931 & 0.000\tabularnewline
par3 & 0.614 & 0.036 & 16.880 & 0.000\tabularnewline
par4 & 0.223 & 0.671 & 0.333 & 0.740\tabularnewline
par5 & -2.326 & 0.697 & -3.337 & 0.001\tabularnewline
\bottomrule
\end{longtable}
...
\midrule
\endhead
par1 & 0.970 & 1.044\tabularnewline
par2 & 1.695 & 1.784\tabularnewline
par3 & 0.543 & 0.685\tabularnewline
par4 & -1.092 & 1.538\tabularnewline
par5 & -3.691 & -0.960\tabularnewline
\bottomrule
\end{longtable}

Alternatively, we can estimate confidence intervals based on quantiles
using bootstrap samples (with n=10) for the estimated coefficients
(Table 15).

\begin{longtable}[]{@{}lrrr@{}}
\caption{Estimated coefficients and 95\% CI based on bootstrap sample
(n= 10) quantiles for \textit{E. ferrugineous} group size
...
\midrule
\endhead
par1 & 1.007 & 0.694 & 0.929\tabularnewline
par2 & 1.739 & 1.842 & 2.150\tabularnewline
par3 & 0.614 & 0.565 & 0.602\tabularnewline
par4 & 0.223 & 0.340 & 0.691\tabularnewline
par5 & -2.326 & -2.850 & -2.457\tabularnewline
\bottomrule
\end{longtable}
...
\begin{figure}[H]
\includegraphics{Patagonia_parrots_density_analysis_files/figure-latex/unnamed-chunk-20-1} \caption{\textit{Enicognathus leptorhynchus} count frequencies}\label{fig:unnamed-chunk-20}
\end{figure}
...
\begin{figure}[H]
\includegraphics{Patagonia_parrots_density_analysis_files/figure-latex/unnamed-chunk-24-1} \caption{\textit{Enicognathus leptorhynchus} group numbers }\label{fig:unnamed-chunk-24}
\end{figure}
...
intervals based on quantiles using bootstrap (with n=10):
...
\midrule
\endhead
P\_(Intercept) & -8.066 & -24.134 & 14.816\tabularnewline
P\_Urban & 8.809 & -32.641 & 11.122\tabularnewline
P\_Agropastoral & 31.024 & -23.261 & 26.760\tabularnewline
V\_(Intercept) & 22.401 & -19.278 & 19.140\tabularnewline
V\_seasonnon-breeding & -17.695 & -28.163 & 11.926\tabularnewline
\bottomrule
\end{longtable}
...
\includegraphics{Patagonia_parrots_density_analysis_files/figure-latex/unnamed-chunk-38-1.pdf}
